 ...
 *External clock source mode 1: PC3 is used as clock input pin,
 *External clock source mode 2: PC1 is used as clock input pin.
 *
 */
...
void TIM1_ETRClockMode2_Init(void)
{
    ...
    TIM_CounterModeConfig(TIM1, TIM_CounterMode_Up);
    TIM_SetAutoreload(TIM1, 0x3EB);
    /* GPIOC1 Input as TIM Clock Source */
