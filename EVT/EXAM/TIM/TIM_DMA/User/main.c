 ...
 *Timer DMA routines:
 *TIM1_CH1(PB9)
 *This example demonstrates using DMA to output PWM through TIM1_CH1(PB9) pin.
 *
 */
...
int main(void)
{
    ...
    printf("SystemClk:%d\r\n", SystemCoreClock);
    printf( "ChipID:%08x\r\n", DBGMCU_GetCHIPID() );
    TIM1_PWMOut_Init(100-1, 7200 - 1, pbuf[0]);
    TIM1_DMA_Init(DMA1_Channel6, (u32)TIM1_CH1CVR_ADDRESS, (u32)pbuf, 3);
