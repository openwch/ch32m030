 ...
 *EXTI_Line7(PA7)
 *This routine demonstrates WFI\WFE enters sleep mode, PA7 pin input low level triggers external
 *interrupt EXTI_Line7 exits stop mode,Program execution continues after wake-up.
 *
*/
