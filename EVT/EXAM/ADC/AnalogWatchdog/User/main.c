 ...
 *ADC channel 0 (PB2), detect that the ADC conversion data on the rule group channel is
...
#else
    ADC_RegularChannelConfig(ADC1, ADC_Channel_0, 1, ADC_SampleTime_5Cycles5);
    ADC_RegularChannelConfig(ADC1, ADC_Channel_1, 2, ADC_SampleTime_5Cycles5);
    ADC_RegularChannelConfig(ADC1, ADC_Channel_2, 3, ADC_SampleTime_5Cycles5);
