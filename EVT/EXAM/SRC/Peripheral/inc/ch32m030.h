...
typedef enum IRQn
{
    ...
    OPA_IRQn = 17,           /* OPA global Interrupt                                 */
    ...
    ADC_IRQn = 29,           /* ADC1 global Interrupt                                */
    ...
    USBPD0_IRQn = 39,        /* USBPD0 global Interrupt                              */
    USBPD0WakeUp_IRQn = 40,  /* USBPD0 WakeUp Interrupt                              */
    USBPD1_IRQn = 41,        /* USBPD1 global Interrupt                              */
    USBPD1WakeUp_IRQn = 42,  /* USBPD1 WakeUp Interrupt                              */
    TIM3_IRQn = 43,          /* TIM3 global Interrupt                                */
    SPI1_IRQn = 44,          /* SPI1 global Interrupt                                */
    USBFS_IRQn = 45,         /* USBFS Interrupt                                      */
    USBFSWakeUp_IRQn = 46,   /* USBFS WakeUp from suspend through EXTI Line Interrupt*/
} IRQn_Type;
...
typedef struct
{
    ...
    __IO uint32_t DLYR;
    __IO uint32_t AVGDR;
    __IO uint32_t RDATAR2;
    __IO uint32_t RDATAR3;
    __IO uint32_t RDATAR4;
} ADC_TypeDef;
...
typedef struct
{
    ...
    uint16_t      RESERVED15;
    __IO uint16_t TIM1_AUX1;
    uint16_t      RESERVED16;
    __IO uint16_t TIM1_AUX2;
    uint16_t      RESERVED17;
    __IO uint16_t TIM1_CH5CVR;
    uint16_t      RESERVED18;
    __IO uint16_t TIM1_CH6CVR;
    uint16_t      RESERVED19;
    __IO uint16_t TIM1_CH7CVR;
    uint16_t      RESERVED20;
    __IO uint16_t TIM1_CH8CVR;
    uint16_t      RESERVED21;
} TIM_TypeDef;
...
typedef struct
{
    __IO uint32_t EXTEN_CTLR0;
    __IO uint32_t EXTEN_KEYR;
    __IO uint32_t EXTEN_CTLR1;
    union
    {
        __IO uint32_t EXTEN_CTLR2;
        struct
        {
            __IO uint16_t ISINK1_CFGR;
            __IO uint16_t ISINK2_CFGR;
        };
    };
} EXTEN_TypeDef;
...
typedef struct
{
    __IO uint32_t QII_CFGR;
    __IO uint32_t ISP_CTLR;
    __IO uint32_t CMP_CTLR;
    __IO uint32_t CMP3_CFGR;
    __IO uint32_t CMP3_SW;
...
#define USBFS_BASE                              (HBPERIPH_BASE + 0x3400)
#define EXTEN_BASE                              (HBPERIPH_BASE + 0x3800)
#define USBPD0_BASE                             (HBPERIPH_BASE + 0x4000)
#define USBPD1_BASE                             (HBPERIPH_BASE + 0x4400)
#define OPA_BASE                                (HBPERIPH_BASE + 0x4800)

#define OB_BASE                                 ((uint32_t)0x1FFFF300)   /* Flash Option Bytes base address */
...
#define USBPD0                                  ((USBPD_TypeDef *)USBPD0_BASE)
#define USBPD1                                  ((USBPD_TypeDef *)USBPD1_BASE)
...
#define ADC_AWD                                 ((uint16_t)0x0001) /* Analog watchdog flag */
#define ADC_EOC                                 ((uint16_t)0x0002) /* End of conversion */
#define ADC_JEOC                                ((uint16_t)0x0004) /* Injected channel end of conversion */
#define ADC_JSTRT                               ((uint16_t)0x0008) /* Injected channel Start flag */
#define ADC_STRT                                ((uint16_t)0x0010) /* Regular channel Start flag */
#define AWD_OVF                                 ((uint16_t)0x0020)
#define AWD_DNF                                 ((uint16_t)0x0040)
#define MULT_CMP3                               ((uint16_t)0x0080)
#define MULT_CMP2                               ((uint16_t)0x0100)
#define MULT_CMP1                               ((uint16_t)0x0200)
...
#define ADC_BUFFEN                              ((uint32_t)0x04000000)
#define ADC_AWD_OVFIE                           ((uint32_t)0x20000000)
#define ADC_AWD_DNFIE                           ((uint32_t)0x40000000)
#define ADC_MULT_CMPEN                          ((uint32_t)0x80000000)
...
#define ADC_ALIGN                               ((uint32_t)0x00000400) /* Data Alignment */

#define ADC_JEXTSEL                             ((uint32_t)0x00007800) /* JEXTSEL[3:0] bits (External event select for injected group) */
#define ADC_JEXTSEL_0                           ((uint32_t)0x00000800) /* Bit 0 */
#define ADC_JEXTSEL_1                           ((uint32_t)0x00001000) /* Bit 1 */
#define ADC_JEXTSEL_2                           ((uint32_t)0x00002000) /* Bit 2 */
#define ADC_JEXTSEL_3                           ((uint32_t)0x00004000) /* Bit 2 */

#define ADC_JEXTTRIG                            ((uint32_t)0x00008000) /* External Trigger Conversion mode for injected channels */

#define ADC_EXTSEL                              ((uint32_t)0x000F0000) /* EXTSEL[3:0] bits (External Event Select for regular group) */
#define ADC_EXTSEL_0                            ((uint32_t)0x00010000) /* Bit 0 */
#define ADC_EXTSEL_1                            ((uint32_t)0x00020000) /* Bit 1 */
#define ADC_EXTSEL_2                            ((uint32_t)0x00040000) /* Bit 2 */
#define ADC_EXTSEL_3                            ((uint32_t)0x00080000) /* Bit 2 */
...
#define ADC_SMP16                               ((uint32_t)0x00000003) /* SMP16[1:0] bits (Channel 16 Sample time selection) */
#define ADC_SMP16_0                             ((uint32_t)0x00000001) /* Bit 0 */
#define ADC_SMP16_1                             ((uint32_t)0x00000002) /* Bit 1 */

#define ADC_SMP17                               ((uint32_t)0x0000000C) /* SMP17[1:0] bits (Channel 17 Sample time selection) */
#define ADC_SMP17_0                             ((uint32_t)0x00000004) /* Bit 0 */
#define ADC_SMP17_1                             ((uint32_t)0x00000008) /* Bit 1 */

#define ADC_SMP18                               ((uint32_t)0x00000030) /* SMP18[1:0] bits (Channel 18 Sample time selection) */
#define ADC_SMP18_0                             ((uint32_t)0x00000010) /* Bit 0 */
#define ADC_SMP18_1                             ((uint32_t)0x00000020) /* Bit 1 */

#define ADC_SMP19                               ((uint32_t)0x000000C0) /* SMP19[1:0] bits (Channel 19 Sample time selection) */
#define ADC_SMP19_0                             ((uint32_t)0x00000040) /* Bit 0 */
#define ADC_SMP19_1                             ((uint32_t)0x00000080) /* Bit 1 */

/******************  Bit definition for ADC_SAMPTR2 register  *******************/
#define ADC_SMP0                                ((uint32_t)0x00000003) /* SMP0[2:0] bits (Channel 0 Sample time selection) */
#define ADC_SMP0_0                              ((uint32_t)0x00000001) /* Bit 0 */
#define ADC_SMP0_1                              ((uint32_t)0x00000002) /* Bit 1 */

#define ADC_SMP1                                ((uint32_t)0x0000000C) /* SMP1[2:0] bits (Channel 1 Sample time selection) */
#define ADC_SMP1_0                              ((uint32_t)0x00000004) /* Bit 0 */
#define ADC_SMP1_1                              ((uint32_t)0x00000008) /* Bit 1 */

#define ADC_SMP2                                ((uint32_t)0x00000030) /* SMP2[2:0] bits (Channel 2 Sample time selection) */
#define ADC_SMP2_0                              ((uint32_t)0x00000010) /* Bit 0 */
#define ADC_SMP2_1                              ((uint32_t)0x00000020) /* Bit 1 */

#define ADC_SMP3                                ((uint32_t)0x000000C0) /* SMP3[2:0] bits (Channel 3 Sample time selection) */
#define ADC_SMP3_0                              ((uint32_t)0x00000040) /* Bit 0 */
#define ADC_SMP3_1                              ((uint32_t)0x00000080) /* Bit 1 */

#define ADC_SMP4                                ((uint32_t)0x00000300) /* SMP4[2:0] bits (Channel 4 Sample time selection) */
#define ADC_SMP4_0                              ((uint32_t)0x00000100) /* Bit 0 */
#define ADC_SMP4_1                              ((uint32_t)0x00000200) /* Bit 1 */

#define ADC_SMP5                                ((uint32_t)0x00000C00) /* SMP5[2:0] bits (Channel 5 Sample time selection) */
#define ADC_SMP5_0                              ((uint32_t)0x00000400) /* Bit 0 */
#define ADC_SMP5_1                              ((uint32_t)0x00000800) /* Bit 1 */

#define ADC_SMP6                                ((uint32_t)0x00003000) /* SMP6[2:0] bits (Channel 6 Sample time selection) */
#define ADC_SMP6_0                              ((uint32_t)0x00001000) /* Bit 0 */
#define ADC_SMP6_1                              ((uint32_t)0x00002000) /* Bit 1 */

#define ADC_SMP7                                ((uint32_t)0x0000C000) /* SMP7[2:0] bits (Channel 7 Sample time selection) */
#define ADC_SMP7_0                              ((uint32_t)0x00004000) /* Bit 0 */
#define ADC_SMP7_1                              ((uint32_t)0x00008000) /* Bit 1 */

#define ADC_SMP8                                ((uint32_t)0x00030000) /* SMP8[2:0] bits (Channel 8 Sample time selection) */
#define ADC_SMP8_0                              ((uint32_t)0x00010000) /* Bit 0 */
#define ADC_SMP8_1                              ((uint32_t)0x00020000) /* Bit 1 */

#define ADC_SMP9                                ((uint32_t)0x000C0000) /* SMP9[2:0] bits (Channel 9 Sample time selection) */
#define ADC_SMP9_0                              ((uint32_t)0x00040000) /* Bit 0 */
#define ADC_SMP9_1                              ((uint32_t)0x00080000) /* Bit 1 */

#define ADC_SMP10                               ((uint32_t)0x00300000) /* SMP10[2:0] bits (Channel 10 Sample time selection) */
#define ADC_SMP10_0                             ((uint32_t)0x00100000) /* Bit 0 */
#define ADC_SMP10_1                             ((uint32_t)0x00200000) /* Bit 1 */

#define ADC_SMP11                               ((uint32_t)0x00C00000) /* SMP11[2:0] bits (Channel 11 Sample time selection) */
#define ADC_SMP11_0                             ((uint32_t)0x00400000) /* Bit 0 */
#define ADC_SMP11_1                             ((uint32_t)0x00800000) /* Bit 1 */

#define ADC_SMP12                               ((uint32_t)0x03000000) /* SMP12[2:0] bits (Channel 12 Sample time selection) */
#define ADC_SMP12_0                             ((uint32_t)0x01000000) /* Bit 0 */
#define ADC_SMP12_1                             ((uint32_t)0x020000000) /* Bit 1 */

#define ADC_SMP13                               ((uint32_t)0x0C000000) /* SMP13[2:0] bits (Channel 13 Sample time selection) */
#define ADC_SMP13_0                             ((uint32_t)0x04000000) /* Bit 0 */
#define ADC_SMP13_1                             ((uint32_t)0x08000000) /* Bit 1 */

#define ADC_SMP14                               ((uint32_t)0x30000000) /* SMP14[2:0] bits (Channel 14 Sample time selection) */
#define ADC_SMP14_0                             ((uint32_t)0x10000000) /* Bit 0 */
#define ADC_SMP14_1                             ((uint32_t)0x20000000) /* Bit 1 */

#define ADC_SMP15                               ((uint32_t)0xC0000000) /* SMP15[2:0] bits (Channel 15 Sample time selection) */
#define ADC_SMP15_0                             ((uint32_t)0x40000000) /* Bit 0 */
#define ADC_SMP15_1                             ((uint32_t)0x80000000) /* Bit 1 */
...
#define ADC_REGU_CH                             ((uint32_t)0x000F0000)

/*******************  Bit definition for ADC_CTLR3 register  *******************/
#define ADC_SW_DIS                              ((uint32_t)0x00000001)
#define ADC_AWD_SCAN                            ((uint32_t)0x00000008)
#define ADC_AWD0_RST_EN                         ((uint32_t)0x00000010)
#define ADC_AWD1_RST_EN                         ((uint32_t)0x00000020)
#define ADC_AWD2_RST_EN                         ((uint32_t)0x00000040)
#define ADC_CH_SAVE                             ((uint32_t)0x00000080)

#define ADC_AWD0_RES                            ((uint32_t)0x00000100)
#define ADC_AWD1_RES                            ((uint32_t)0x00000200)
#define ADC_AWD2_RES                            ((uint32_t)0x00000400)

#define ADC_OVIF                                ((uint32_t)0x00010000)
#define ADC_DNIF                                ((uint32_t)0x00020000)
#define ADC_OF                                  ((uint32_t)0x00040000)
#define ADC_DF                                  ((uint32_t)0x00080000)

#define ADC_AVG_K                               ((uint32_t)0x00700000) /*AVG_K[2:0] */
#define ADC_AVG_K_0                             ((uint32_t)0x00100000)
#define ADC_AVG_K_1                             ((uint32_t)0x00200000)
#define ADC_AVG_K_2                             ((uint32_t)0x00400000)

#define ADC_AVG_EN                              ((uint32_t)0x00800000)
#define ADC_AVG_OVIE                            ((uint32_t)0x01000000)
#define ADC_AVG_DNIE                            ((uint32_t)0x02000000)
#define ADC_CMP_XOR_MODE                        ((uint32_t)0x04000000)
#define ADC_RDR_POLL                            ((uint32_t)0x08000000)

/*******************  Bit definition for ADC_WDTR1 register  *******************/
#define ADC_LT1                                 ((uint32_t)0x00000FFF)
#define ADC_HT1                                 ((uint32_t)0x0FFF0000)

/*******************  Bit definition for ADC_WDTR2 register  *******************/
#define ADC_LT2                                 ((uint32_t)0x00000FFF)
#define ADC_HT2                                 ((uint32_t)0x0FFF0000)

/*******************  Bit definition for ADC_AVG_TR register  *******************/
#define ADC_AVG_LTR                             ((uint32_t)0x00000FFF)
#define ADC_AVG_HTR                             ((uint32_t)0x0FFF0000)

/*******************  Bit definition for ADC_DLYR register  *******************/
#define ADC_DLYVLU                              ((uint32_t)0x000001FF)
#define ADC_DLYSRC                              ((uint32_t)0x00000200)

/*******************  Bit definition for ADC_AVG_DR register  *******************/
#define ADC_AVG_DG                              ((uint32_t)0x00000FFF)

/*******************  Bit definition for ADC_RDATAR2 register  *******************/
#define ADC_RDATAR2_DATA                        ((uint32_t)0x00000FFF)

/*******************  Bit definition for ADC_RDATAR3 register  *******************/
#define ADC_RDATAR3_DATA                        ((uint32_t)0x00000FFF)

/*******************  Bit definition for ADC_RDATAR4 register  *******************/
#define ADC_RDATAR4_DATA                        ((uint32_t)0x00000FFF)
...
#define FLASH_ACTLR_LATENCY                     ((uint8_t)0x07) /* LATENCY[2:0] bits (Latency) */
...
#define FLASH_STATR_ERR_FATAL                   ((uint32_t)0x00020000)
#define FLASH_STATR_ERR_COR                     ((uint32_t)0x00040000)
#define FLASH_STATR_NOERR                       ((uint32_t)0x00080000)
#define FLASH_STATR_ECCERRIF                    ((uint32_t)0x00100000)
...
#define FLASH_CTLR_ECCERRIE                     ((uint16_t)0x00100000)
#define FLASH_CTLR_ECCCORIE                     ((uint16_t)0x00200000)
...
#define FLASH_OBR_RST_MODE                      ((uint16_t)0x0060) /* RST MODE */
#define FLASH_OBR_RST_PIN_SEL                   ((uint16_t)0x0080) /* RST Pin Select */
#define FLASH_OBR_OV_CFG                        ((uint16_t)0x0200) /* Over-voltage protection Selection */
...
/******************  Bit definition for FLASH_CTLR2 register  ******************/
#define FLASH_CTLR2_VDD8_SEL                    ((uint8_t)0x60)
...
#define AFIO_PCFR1_I2C1_REMAP_0                 ((uint32_t)0x00000001) /* Bit 0 */
#define AFIO_PCFR1_I2C1_REMAP_1                 ((uint32_t)0x00000002) /* Bit 1 */

#define AFIO_PCFR1_UART1_REMAP                  ((uint32_t)0x0000001C) /* UART1_REMAP[2:0] bits*/
#define AFIO_PCFR1_UART1_REMAP_0                ((uint32_t)0x00000004) /* Bit 0 */
#define AFIO_PCFR1_UART1_REMAP_1                ((uint32_t)0x00000008) /* Bit 1 */
#define AFIO_PCFR1_UART1_REMAP_2                ((uint32_t)0x00000010) /* Bit 2 */

#define AFIO_PCFR1_SPI1_REMAP                   ((uint32_t)0x00000060) /* SPI1_REMAP[1:0] bits*/
#define AFIO_PCFR1_SPI1_REMAP_0                 ((uint32_t)0x00000020) /* Bit 0 */
#define AFIO_PCFR1_SPI1_REMAP_1                 ((uint32_t)0x00000040) /* Bit 1 */

#define AFIO_PCFR1_TIM1_REMAP                   ((uint32_t)0x00000380) /* TIM1_REMAP[2:0] bits*/
#define AFIO_PCFR1_TIM1_REMAP_0                 ((uint32_t)0x00000080) /* Bit 0 */
#define AFIO_PCFR1_TIM1_REMAP_1                 ((uint32_t)0x00000100) /* Bit 1 */
#define AFIO_PCFR1_TIM1_REMAP_2                 ((uint32_t)0x00000200) /* Bit 2 */

#define AFIO_PCFR1_TIM2_REMAP                   ((uint32_t)0x00000C00) /* TIM2_REMAP[1:0] bits*/
#define AFIO_PCFR1_TIM2_REMAP_0                 ((uint32_t)0x00000400) /* Bit 0 */
#define AFIO_PCFR1_TIM2_REMAP_1                 ((uint32_t)0x00000800) /* Bit 1 */

#define AFIO_PCFR1_TIM3_REMAP                   ((uint32_t)0x00007000) /* TIM3_REMAP[2:0] bits*/
#define AFIO_PCFR1_TIM3_REMAP_0                 ((uint32_t)0x00001000) /* Bit 0 */
#define AFIO_PCFR1_TIM3_REMAP_1                 ((uint32_t)0x00002000) /* Bit 1 */
#define AFIO_PCFR1_TIM3_REMAP_2                 ((uint32_t)0x00004000) /* Bit 2 */

#define AFIO_PCFR1_ADC_ETRGIN_REMAP             ((uint32_t)0x00008000)
#define AFIO_PCFR1_PB5PB6_REMAP                 ((uint32_t)0x00010000)
#define AFIO_PCFR1_HO_DIO_EN0_REMAP             ((uint32_t)0x00020000)
#define AFIO_PCFR1_HO_DIO_EN1_REMAP             ((uint32_t)0x00040000)
#define AFIO_PCFR1_HO_DIO_EN2_REMAP             ((uint32_t)0x00080000)
#define AFIO_PCFR1_HO_DIO_EN3_REMAP             ((uint32_t)0x00100000)
...
#define AFIO_PCFR1_SWJ_CFG_ENABLE               ((uint32_t)0x00000000) /* SWJ Enabled */
#define AFIO_PCFR1_SWJ_CFG_DISABLE              ((uint32_t)0x04000000) /* SWJ Disabled */
...
#define PWR_CTLR_ISINKEN                        ((uint16_t)0x0100)

#define PWR_CTLR_SEL_IO_VHV                     ((uint16_t)0x3000) /*SEL_IO_VHV[1:0] bits*/
#define PWR_CTLR_SEL_IO_VHV_0                   ((uint16_t)0x1000) /* Bit 0 */
#define PWR_CTLR_SEL_IO_VHV_1                   ((uint16_t)0x2000) /* Bit 1 */

#define PWR_CTLR_PMUPROEN                       ((uint16_t)0x4000)

/*******************  Bit definition for PWR_AWUCSR register  ********************/
#define PWR_AWUEN                               ((uint16_t)0x0002) /* Wakeup Flag */

/*******************  Bit definition for PWR_AWUWR register  ********************/
#define PWR_AWUWR                               ((uint16_t)0x000F) /* Wakeup Flag */
...
#define RCC_HPRE                                ((uint32_t)0x000007F0) /* HPRE[6:0] bits (HB prescaler) */
...
#define RCC_HPRE_4                              ((uint32_t)0x00000100) /* Bit 4 */
#define RCC_HPRE_5                              ((uint32_t)0x00000200) /* Bit 5 */
#define RCC_HPRE_6                              ((uint32_t)0x00000400) /* Bit 6 */
...
#define RCC_ADCPRE_2                            ((uint32_t)0x00002000) /* Bit 1 */
#define RCC_ADCPRE_3                            ((uint32_t)0x00004000) /* Bit 1 */
#define RCC_ADCPRE_4                            ((uint32_t)0x00008000) /* Bit 1 */
...
#define RCC_ADC_DUTY_SEL                        ((uint32_t)0x10000000)
...
#define RCC_USBFSEN                             ((uint16_t)0x0008)
#define RCC_USBPD0EN                            ((uint16_t)0x0010)
#define RCC_USBPD1EN                            ((uint16_t)0x0020)
#define RCC_OPAEN                               ((uint16_t)0x0080)
...
#define RCC_USBPD0RSTF                          ((uint32_t)0x00400000)
#define RCC_USBPD1RSTF                          ((uint32_t)0x00800000)
#define RCC_RMVF                                ((uint32_t)0x01000000) /* Remove reset flag */
#define RCC_ADCAWDRSTF                          ((uint32_t)0x02000000)
...
/******************  Bit definition for SPI_TCRCR register  ******************/
#define SPI_HSCR_HSRXEN                         ((uint16_t)0xFFFF) /* High Speed mode read Enable */
...
#define TIM_CO1NE                               ((uint16_t)0x0400) /* Channel 1 and complementary channel output enable*/
#define TIM_CO2NE                               ((uint16_t)0x0800) /* Channel 2 and complementary channel output enable*/

#define TIM_CH2_PWMOUT_EN                       ((uint16_t)0x1000) /* TIM2 PWM OUT Pin config*/
...
#define TIM_CAP_ED_CH2                          ((uint16_t)0x0001) /* Channel 2 Dual Edge Capture Enable. Only for TIM2*/
#define TIM_CAP_ED_CH3                          ((uint16_t)0x0002) /* Channel 3 Dual Edge Capture Enable. Only for TIM2*/
#define TIM_CAP_ED_CH4                          ((uint16_t)0x0004) /* Channel 4 Dual Edge Capture Enable. Only for TIM2*/
...
#define TIM_TIM2_ADC_CAP                        ((uint16_t)0x0100) /* Capture ADC Module Signal Edge Function Enable. Only for TIM2*/
#define TIM_TIM2_HSCK_MODE                      ((uint16_t)0x0200) /* Counter Clock Selection. Only for TIM2*/
...
#define TIM_DT1                                 ((uint16_t)0x0F00) /* DT1[3:0] TIM3 Channel 1 Dead Time Configuration */
...
#define TIM_DT2                                 ((uint16_t)0xF000) /* DT2[3:0] TIM3 Channel 2 Dead Time Configuration*/
...
#define TIM_TIM3_CCDS                           ((uint16_t)0x0800)
...
#define TIM_CO1P                                ((uint16_t)0x0040) /* TIM3 Channel 1 Output Polarity*/
#define TIM_CO2P                                ((uint16_t)0x0080) /* TIM3 Channel 2 Output Polarity*/
#define TIM_CO1NP                               ((uint16_t)0x0100) /* TIM3 Channel 1 Complementary Output Polarity*/
#define TIM_CO2NP                               ((uint16_t)0x0200) /* TIM3 Channel 2 Complementary Output Polarity*/
#define TIM_CAP_ED                              ((uint16_t)0x0400) /* TIM3 Channel 2 Bilateral Edge Capture Enable*/
#define TIM_TIM3_ADC_CAP                        ((uint16_t)0x0800) /* TIM3 Capture ADC Module Signal Edge Function Enable*/
#define TIM_TIM3_DT_DIV                         ((uint16_t)0x1000) /* TIM3 Dead time count clock divider enable*/
#define TIM_TIM3_HSCK_MODE                      ((uint16_t)0x2000) /* TIM3 Counter Clock Selection*/
...
#define TIM_OC1N_EN                             ((uint16_t)0x0001)
#define TIM_OC2N_EN                             ((uint16_t)0x0002)
#define TIM_DT1_P                               ((uint16_t)0x0004)
#define TIM_DT1N_P                              ((uint16_t)0x0008)
#define TIM_DT2_P                               ((uint16_t)0x0010)
#define TIM_DT2N_P                              ((uint16_t)0x0020)
#define TIM_TIM2_DT_DIV                         ((uint16_t)0x0040)

#define TIM_DT1                                 ((uint16_t)0x0F00) /* DT1[3:0] TIM2 Channel 1 Dead Time Configuration */
#define TIM_DT1_0                               ((uint16_t)0x0100) /* Bit 0 */
#define TIM_DT1_1                               ((uint16_t)0x0200) /* Bit 1 */
#define TIM_DT1_2                               ((uint16_t)0x0400) /* Bit 2 */
#define TIM_DT1_3                               ((uint16_t)0x0800) /* Bit 3 */

#define TIM_DT2                                 ((uint16_t)0xF000) /* DT2[3:0] TIM2 Channel 2 Dead Time Configuration */
#define TIM_DT2_0                               ((uint16_t)0x1000) /* Bit 0 */
#define TIM_DT2_1                               ((uint16_t)0x2000) /* Bit 1 */
#define TIM_DT2_2                               ((uint16_t)0x4000) /* Bit 2 */
#define TIM_DT2_3                               ((uint16_t)0x8000) /* Bit 3 */
...
/*******************  Bit definition for TIM_AUX1 register  *******************/
#define TIM_CAP_ED_CH2                          ((uint16_t)0x0001)
#define TIM_CAP_ED_CH3                          ((uint16_t)0x0002)
#define TIM_CAP_ED_CH4                          ((uint16_t)0x0004)
#define TIM_CMS_SPEC                            ((uint16_t)0x0008)

#define TIM_OC5PE                               ((uint16_t)0x0020)
#define TIM_OC6PE                               ((uint16_t)0x0040)
#define TIM_OC7PE                               ((uint16_t)0x0080)
#define TIM_OC8PE                               ((uint16_t)0x0100)

#define TIM_CC5DE                               ((uint16_t)0x0200)
#define TIM_TIM1_ADC_CAP                        ((uint16_t)0x0400)
#define TIM_CC1N_SPEC_EN                        ((uint16_t)0x0800)
#define TIM_CC2N_SPEC_EN                        ((uint16_t)0x1000)
#define TIM_CC3N_SPEC_EN                        ((uint16_t)0x2000)

#define TIM_TIM1_HSCK_MODE                      ((uint16_t)0x0800)

/*******************  Bit definition for TIM_AUX2 register  *******************/
#define TIM_DT_VLU2                             ((uint16_t)0x00FF) /* DT_VLU2[7:0] bits*/
#define TIM_DT_VLU2_0                           ((uint16_t)0x0001) /* Bit 0 */
#define TIM_DT_VLU2_1                           ((uint16_t)0x0002) /* Bit 1 */
#define TIM_DT_VLU2_2                           ((uint16_t)0x0004) /* Bit 2 */
#define TIM_DT_VLU2_3                           ((uint16_t)0x0008) /* Bit 3 */
#define TIM_DT_VLU2_4                           ((uint16_t)0x0010) /* Bit 4 */
#define TIM_DT_VLU2_5                           ((uint16_t)0x0020) /* Bit 5 */
#define TIM_DT_VLU2_6                           ((uint16_t)0x0040) /* Bit 6 */
#define TIM_DT_VLU2_7                           ((uint16_t)0x0080) /* Bit 7 */

#define TIM_DTP_MODE                            ((uint16_t)0x0100)
#define TIM_DTN_MODE                            ((uint16_t)0x0200)

#define TIM_OC5M                                ((uint16_t)0x0400)
#define TIM_OC5CE                               ((uint16_t)0x0800)
#define TIM_OC1NM                               ((uint16_t)0x1000)
#define TIM_OC2NM                               ((uint16_t)0x2000)
#define TIM_OC3NM                               ((uint16_t)0x4000)
#define TIM_CC5P                                ((uint16_t)0x8000)

/*******************  Bit definition for TIM_CH5CVR register  *******************/
#define TIM_CCR5                                ((uint16_t)0xFFFF)

/*******************  Bit definition for TIM_CH6CVR register  *******************/
#define TIM_CCR6                                ((uint16_t)0xFFFF)

/*******************  Bit definition for TIM_CH7CVR register  *******************/
#define TIM_CCR7                                ((uint16_t)0xFFFF)

/*******************  Bit definition for TIM_CH8CVR register  *******************/
#define TIM_CCR8                                ((uint16_t)0xFFFF)
...
#define UART_STATR_RX_BUSY                     ((uint16_t)0x0400)
...
#define UART_CTLR2_STOP_0                      ((uint16_t)0x1000) /* Bit 0 */
#define UART_CTLR2_STOP_1                      ((uint16_t)0x2000) /* Bit 1 */
...
#define UART_GPR_PSC_0                         ((uint16_t)0x0001) /* Bit 0 */
#define UART_GPR_PSC_1                         ((uint16_t)0x0002) /* Bit 1 */
#define UART_GPR_PSC_2                         ((uint16_t)0x0004) /* Bit 2 */
#define UART_GPR_PSC_3                         ((uint16_t)0x0008) /* Bit 3 */
#define UART_GPR_PSC_4                         ((uint16_t)0x0010) /* Bit 4 */
#define UART_GPR_PSC_5                         ((uint16_t)0x0020) /* Bit 5 */
#define UART_GPR_PSC_6                         ((uint16_t)0x0040) /* Bit 6 */
#define UART_GPR_PSC_7                         ((uint16_t)0x0080) /* Bit 7 */
...
/*******************  Bit definition for QII_CFGR register  *******************/
#define QII_CFGR_QII1_AE                        ((uint32_t)0x00000001)
#define QII_CFGR_QII1_HYPSEL                    ((uint32_t)0x00000002)
#define QII_CFGR_QII1_AVSEL                     ((uint32_t)0x00000004)
#define QII_CFGR_QII2_AE                        ((uint32_t)0x00000008)
#define QII_CFGR_QII2_OPAEN                     ((uint32_t)0x00000010)
#define QII_CFGR_QII2_SESEL                     ((uint32_t)0x00000020)

#define QII_CFGR_QII2_AVSEL                     ((uint32_t)0x000000C0) /* QII2_AVSEL[1:0] bits*/
#define QII_CFGR_QII2_AVSEL_0                   ((uint32_t)0x00000040)
#define QII_CFGR_QII2_AVSEL_1                   ((uint32_t)0x00000080)

#define QII_CFGR_QII2_HYPSEL                    ((uint32_t)0x00000700) /* QII2_HYPSEL[2:0] bits*/
#define QII_CFGR_QII2_HYPSEL_0                  ((uint32_t)0x00000100)
#define QII_CFGR_QII2_HYPSEL_1                  ((uint32_t)0x00000200)
#define QII_CFGR_QII2_HYPSEL_2                  ((uint32_t)0x00000400)

#define QII_CFGR_QII2_DACEN                     ((uint32_t)0x00001000)

#define QII_CFGR_QII2_DAC                       ((uint32_t)0x0001E000) /* QII2_DAC[3:0] bits*/
#define QII_CFGR_QII2_DAC_0                     ((uint32_t)0x00002000)
#define QII_CFGR_QII2_DAC_1                     ((uint32_t)0x00004000)
#define QII_CFGR_QII2_DAC_2                     ((uint32_t)0x00008000)
#define QII_CFGR_QII2_DAC_3                     ((uint32_t)0x00010000)

#define QII_CFGR_QII2_CHNSEL                    ((uint32_t)0x000C0000) /* QII2_CHNSEL[1:2] bits*/
#define QII_CFGR_QII2_CHNSEL_0                  ((uint32_t)0x00040000)
#define QII_CFGR_QII2_CHNSEL_1                  ((uint32_t)0x00080000)

#define QII_CFGR_QII2_CHPSEL                    ((uint32_t)0x00300000) /* QII2_CHPSEL[1:2] bits*/
#define QII_CFGR_QII2_CHPSEL_0                  ((uint32_t)0x00100000)
#define QII_CFGR_QII2_CHPSEL_1                  ((uint32_t)0x00200000)

/*******************  Bit definition for ISP_CTLR register  *******************/
#define ISP_CTLR_ISP1_EN                        ((uint32_t)0x00000001)

#define ISP_CTLR_ISP1_GAIN                      ((uint32_t)0x00000006) /* ISP1_GAIN [1:0] bits*/
#define ISP_CTLR_ISP1_GAIN_0                    ((uint32_t)0x00000002)
#define ISP_CTLR_ISP1_GAIN_1                    ((uint32_t)0x00000004)

#define ISP_CTLR_ISP1_VFBIAS                    ((uint32_t)0x00000008)
#define ISP_CTLR_ISP1_NSEL                      ((uint32_t)0x00000010)
#define ISP_CTLR_ISP1_SEL_IO                    ((uint32_t)0x00000020)
#define ISP_CTLR_ISP1_QDET1_EN                  ((uint32_t)0x00000040)
#define ISP_CTLR_ISP1_QDET1_PD30K               ((uint32_t)0x00000080)
#define ISP_CTLR_ISP1_QDET1_VBSEL               ((uint32_t)0x00000100)

#define ISP_CTLR_ISP2_EN                        ((uint32_t)0x00010000)

#define ISP_CTLR_ISP2_GAIN                      ((uint32_t)0x00060000) /* ISP2_GAIN [1:0] bits*/
#define ISP_CTLR_ISP2_GAIN_0                    ((uint32_t)0x00020000)
#define ISP_CTLR_ISP2_GAIN_1                    ((uint32_t)0x00040000)

#define ISP_CTLR_ISP2_VFBIAS                    ((uint32_t)0x00080000)
#define ISP_CTLR_ISP2_NSEL                      ((uint32_t)0x00100000)
#define ISP_CTLR_ISP2_SEL_IO                    ((uint32_t)0x00200000)
#define ISP_CTLR_ISP2_QDET1_EN                  ((uint32_t)0x00400000)
#define ISP_CTLR_ISP2_QDET1_PD30K               ((uint32_t)0x00800000)
#define ISP_CTLR_ISP2_QDET1_VBSEL               ((uint32_t)0x01000000)

/*******************  Bit definition for CMP_CTLR register  *******************/
#define CMP_CTLR_CMP1_FILT_EN                   ((uint32_t)0x00000001)

#define CMP_CTLR_CMP1_FILT_CFG                  ((uint32_t)0x0000003E) /* CMP1_FILT_CFG[4:0] bits*/
#define CMP_CTLR_CMP1_FILT_CFG_0                ((uint32_t)0x00000002)
#define CMP_CTLR_CMP1_FILT_CFG_1                ((uint32_t)0x00000004)
#define CMP_CTLR_CMP1_FILT_CFG_2                ((uint32_t)0x00000008)
#define CMP_CTLR_CMP1_FILT_CFG_3                ((uint32_t)0x00000010)
#define CMP_CTLR_CMP1_FILT_CFG_4                ((uint32_t)0x00000020)

#define CMP_CTLR_CMP2_FILT_EN                   ((uint32_t)0x00000040)

#define CMP_CTLR_CMP2_FILT_CFG                  ((uint32_t)0x00000F80) /* CMP2_FILT_CFG[4:0] bits*/
#define CMP_CTLR_CMP2_FILT_CFG_0                ((uint32_t)0x00000080)
#define CMP_CTLR_CMP2_FILT_CFG_1                ((uint32_t)0x00000100)
#define CMP_CTLR_CMP2_FILT_CFG_2                ((uint32_t)0x00000200)
#define CMP_CTLR_CMP2_FILT_CFG_3                ((uint32_t)0x00000400)
#define CMP_CTLR_CMP2_FILT_CFG_4                ((uint32_t)0x00000800)

#define CMP_CTLR_CMP2_BK_EN                     ((uint32_t)0x00001000)
#define CMP_CTLR_CMP2_INT_EN                    ((uint32_t)0x00002000)

#define CMP_CTLR_CMP3_TRG_SRC                   ((uint32_t)0x0001C000) /* CMP3_TRG_SRC[2:0] bits*/
#define CMP_CTLR_CMP3_TRG_SRC_0                 ((uint32_t)0x00004000)
#define CMP_CTLR_CMP3_TRG_SRC_1                 ((uint32_t)0x00008000)
#define CMP_CTLR_CMP3_TRG_SRC_2                 ((uint32_t)0x00010000)

#define CMP_CTLR_CMP3_TRG_GATE                  ((uint32_t)0x00020000)
#define CMP_CTLR_QII_CAP_EN                     ((uint32_t)0x00040000)
#define CMP_CTLR_CMP3_COM_MODE                  ((uint32_t)0x00080000)
#define CMP_CTLR_CMP3_FILT_EN                   ((uint32_t)0x00100000)

#define CMP_CTLR_CMP3_FILT_CFG                  ((uint32_t)0x03E00000) /* CMP3_FILT_CFG[4:0] bits*/
#define CMP_CTLR_CMP3_FILT_CFG_0                ((uint32_t)0x00200000)
#define CMP_CTLR_CMP3_FILT_CFG_1                ((uint32_t)0x00400000)
#define CMP_CTLR_CMP3_FILT_CFG_2                ((uint32_t)0x00800000)
#define CMP_CTLR_CMP3_FILT_CFG_3                ((uint32_t)0x01000000)
#define CMP_CTLR_CMP3_FILT_CFG_4                ((uint32_t)0x02000000)

#define CMP_CTLR_CMP3_BK_EN                     ((uint32_t)0x04000000)
#define CMP_CTLR_CMP3_INT_EN                    ((uint32_t)0x08000000)
#define CMP_CTLR_CMP2_TO_IO                     ((uint32_t)0x10000000)
#define CMP_CTLR_CMP1_TO_IO                     ((uint32_t)0x20000000)
#define CMP_CTLR_CMP3_CAP                       ((uint32_t)0x40000000)

/*******************  Bit definition for CMP3_CFGR register  *******************/
#define CMP_CTLR_CMP3_EN                        ((uint32_t)0x00000001)

#define CMP_CTLR_CMP3_PSEL                      ((uint32_t)0x0000000E) /* CMP3_PSEL[2:0] bits*/
#define CMP_CTLR_CMP3_PSEL_0                    ((uint32_t)0x00000002)
#define CMP_CTLR_CMP3_PSEL_1                    ((uint32_t)0x00000004)
#define CMP_CTLR_CMP3_PSEL_2                    ((uint32_t)0x00000008)

#define CMP_CTLR_CMP3_NSEL                      ((uint32_t)0x00000070) /* CMP3_NSEL[2:0] bits*/
#define CMP_CTLR_CMP3_NSEL_0                    ((uint32_t)0x00000010)
#define CMP_CTLR_CMP3_NSEL_1                    ((uint32_t)0x00000020)
#define CMP_CTLR_CMP3_NSEL_2                    ((uint32_t)0x00000040)

#define CMP_CTLR_CMP3_HYS                       ((uint32_t)0x00000180) /* CMP3_HYS[1:0] bits*/
#define CMP_CTLR_CMP3_HYS_0                     ((uint32_t)0x00000080)
#define CMP_CTLR_CMP3_HYS_1                     ((uint32_t)0x00000100)

#define CMP_CTLR_CMP3_RMID                      ((uint32_t)0x00000200)

#define CMP_CTLR_CMP3_DACDAT                    ((uint32_t)0x00003C00) /* DACAT[3:0]*/
#define CMP_CTLR_CMP3_DACDAT_0                  ((uint32_t)0x00000400)
#define CMP_CTLR_CMP3_DACDAT_1                  ((uint32_t)0x00000800)
#define CMP_CTLR_CMP3_DACDAT_2                  ((uint32_t)0x00001000)
#define CMP_CTLR_CMP3_DACDAT_3                  ((uint32_t)0x00002000)

#define CMP_CTLR_CMP3_OEN                       ((uint32_t)0x00004000)
#define CMP_CTLR_CMP3_OE                        ((uint32_t)0x00008000)
#define CMP_CTLR_CMP3_MODE_IOSEL                ((uint32_t)0x00010000)

/*******************  Bit definition for CMP3_SW register  *******************/
#define CMP3_SW_CH_NUM                          ((uint32_t)0x00000003) /* CH_NUM[1:0] bits*/
#define CMP3_SW_CH_NUM_0                        ((uint32_t)0x00000001)
#define CMP3_SW_CH_NUM_1                        ((uint32_t)0x00000002)

#define CMP3_SW_OUT_POL_CH1                     ((uint32_t)0x00000004)
#define CMP3_SW_OUT_POL_CH2                     ((uint32_t)0x00000008)
#define CMP3_SW_OUT_POL_CH3                     ((uint32_t)0x00000010)
#define CMP3_SW_OUT_POL_CH4                     ((uint32_t)0x00000020)

/*******************  Bit definition for CMP_STATR register  *******************/
#define CMP_STATR_CMP1_OUT                      ((uint32_t)0x00000001)
#define CMP_STATR_CMP1_OUT_FILT                 ((uint32_t)0x00000002)
#define CMP_STATR_CMP2_OUT                      ((uint32_t)0x00000100)
#define CMP_STATR_CMP2_OUT_FILT                 ((uint32_t)0x00000200)

#define CMP_STATR_CMP2_COMIF                    ((uint32_t)0x00000400)
#define CMP_STATR_CMP3_OUT                      ((uint32_t)0x00010000)
#define CMP_STATR_CMP3_OUT_FILT                 ((uint32_t)0x00020000)

#define CMP_STATR_CMP3_CHOUT0                   ((uint32_t)0x00040000)
#define CMP_STATR_CMP3_CHOUT1                   ((uint32_t)0x00080000)
#define CMP_STATR_CMP3_CHOUT2                   ((uint32_t)0x00100000)
#define CMP_STATR_CMP3_CHOUT3                   ((uint32_t)0x00200000)
...
#define EXTEN_USBPD0_CC_REF                     ((uint32_t)0x00010000)
#define EXTEN_USBPD1_CC_REF                     ((uint32_t)0x00020000)
#define EXTEN_USBPD0_CC_HVT                     ((uint32_t)0x00040000)
#define EXTEN_USBPD1_CC_HVT                     ((uint32_t)0x00080000)

#define EXTEN_USBPD0_LVE_T                      ((uint32_t)0x00300000) /* USBPD0_LVE_T[1:0] bits*/
#define EXTEN_USBPD0_LVE_T_0                    ((uint32_t)0x00100000)
#define EXTEN_USBPD0_LVE_T_1                    ((uint32_t)0x00200000)

#define EXTEN_USBPD1_LVE_T                      ((uint32_t)0x00C00000) /* USBPD1_LVE_T[1:0] bits*/
#define EXTEN_USBPD1_LVE_T_0                    ((uint32_t)0x00400000)
#define EXTEN_USBPD1_LVE_T_1                    ((uint32_t)0x00800000)

#define EXTEN_ISR_C1_EN                         ((uint32_t)0x01000000)
#define EXTEN_ISR_C1_SEL                        ((uint32_t)0x02000000)
#define EXTEN_ISR_C2_EN                         ((uint32_t)0x04000000)
#define EXTEN_ISR_C2_SEL                        ((uint32_t)0x08000000)

/*******************  Bit definition for EXTEN_KEYR register  *******************/
#define EXTEN_KEY_R                             ((uint32_t)0xFFFFFFFF)
#define EXTEN_KEY1                              ((uint32_t)0x45670123)
#define EXTEN_KEY2                              ((uint32_t)0xCDEF89AB)
...
#define EXTEN_UDP_DAC                           ((uint32_t)0x000007E0) /* UDP_DAC[5:0] bits*/
#define EXTEN_UDP_DAC_0                         ((uint32_t)0x00000020)
#define EXTEN_UDP_DAC_1                         ((uint32_t)0x00000040)
#define EXTEN_UDP_DAC_2                         ((uint32_t)0x00000080)
#define EXTEN_UDP_DAC_3                         ((uint32_t)0x00000100)
#define EXTEN_UDP_DAC_4                         ((uint32_t)0x00000200)
#define EXTEN_UDP_DAC_5                         ((uint32_t)0x00000400)

#define EXTEN_UDP_AE                            ((uint32_t)0x00000800)
#define EXTEN_UDP_AI                            ((uint32_t)0x00001000)
#define EXTEN_UDP_RAT                           ((uint32_t)0x00002000)
#define EXTEN_UDP_IE                            ((uint32_t)0x00004000)
...
#define EXTEN_UDM_DAC                           ((uint32_t)0x07E00000) /* UDM_DAC[5:0] bits*/
#define EXTEN_UDM_DAC_0                         ((uint32_t)0x00200000)
#define EXTEN_UDM_DAC_1                         ((uint32_t)0x00400000)
#define EXTEN_UDM_DAC_2                         ((uint32_t)0x00800000)
#define EXTEN_UDM_DAC_3                         ((uint32_t)0x01000000)
#define EXTEN_UDM_DAC_4                         ((uint32_t)0x02000000)
#define EXTEN_UDM_DAC_5                         ((uint32_t)0x04000000)

#define EXTEN_UDM_AE                            ((uint32_t)0x08000000)
#define EXTEN_UDM_AI                            ((uint32_t)0x10000000)
#define EXTEN_UDM_RAT                           ((uint32_t)0x20000000)
#define EXTEN_UDM_IE                            ((uint32_t)0x40000000)

#define EXTEN_UDU_SHRT                          ((uint32_t)0x80000000)

/*******************  Bit definition for EXTEN_CTLR2 register  *******************/
#define EXTEN_ISINK1_ADJ                        ((uint32_t)0x0000003F) /* ISINK1_ADJ[5:0] bits*/
#define EXTEN_ISINK1_ADJ_0                      ((uint32_t)0x00000001)
#define EXTEN_ISINK1_ADJ_1                      ((uint32_t)0x00000002)
#define EXTEN_ISINK1_ADJ_2                      ((uint32_t)0x00000004)
#define EXTEN_ISINK1_ADJ_3                      ((uint32_t)0x00000008)
#define EXTEN_ISINK1_ADJ_4                      ((uint32_t)0x00000010)
#define EXTEN_ISINK1_ADJ_5                      ((uint32_t)0x00000020)

#define EXTEN_ISINK1_DAT                        ((uint32_t)0x0000FFC0) /* ISINK1_DAT[9:0] bits*/
#define EXTEN_ISINK1_DAT_0                      ((uint32_t)0x00000040)
#define EXTEN_ISINK1_DAT_1                      ((uint32_t)0x00000080)
#define EXTEN_ISINK1_DAT_2                      ((uint32_t)0x00000100)
#define EXTEN_ISINK1_DAT_3                      ((uint32_t)0x00000200)
#define EXTEN_ISINK1_DAT_4                      ((uint32_t)0x00000400)
#define EXTEN_ISINK1_DAT_5                      ((uint32_t)0x00000800)
#define EXTEN_ISINK1_DAT_6                      ((uint32_t)0x00001000)
#define EXTEN_ISINK1_DAT_7                      ((uint32_t)0x00002000)
#define EXTEN_ISINK1_DAT_8                      ((uint32_t)0x00004000)
#define EXTEN_ISINK1_DAT_9                      ((uint32_t)0x00008000)

#define EXTEN_ISINK2_ADJ                        ((uint32_t)0x003F0000) /* ISINK2_ADJ[5:0] bits*/
#define EXTEN_ISINK2_ADJ_0                      ((uint32_t)0x00010000)
#define EXTEN_ISINK2_ADJ_1                      ((uint32_t)0x00020000)
#define EXTEN_ISINK2_ADJ_2                      ((uint32_t)0x00040000)
#define EXTEN_ISINK2_ADJ_3                      ((uint32_t)0x00080000)
#define EXTEN_ISINK2_ADJ_4                      ((uint32_t)0x00100000)
#define EXTEN_ISINK2_ADJ_5                      ((uint32_t)0x00200000)

#define EXTEN_ISINK2_DAT                        ((uint32_t)0xFFC00000) /* ISINK2_DAT[9:0] bits*/
#define EXTEN_ISINK2_DAT_0                      ((uint32_t)0x00400000)
#define EXTEN_ISINK2_DAT_1                      ((uint32_t)0x00800000)
#define EXTEN_ISINK2_DAT_2                      ((uint32_t)0x01000000)
#define EXTEN_ISINK2_DAT_3                      ((uint32_t)0x02000000)
#define EXTEN_ISINK2_DAT_4                      ((uint32_t)0x04000000)
#define EXTEN_ISINK2_DAT_5                      ((uint32_t)0x08000000)
#define EXTEN_ISINK2_DAT_6                      ((uint32_t)0x10000000)
#define EXTEN_ISINK2_DAT_7                      ((uint32_t)0x20000000)
#define EXTEN_ISINK2_DAT_8                      ((uint32_t)0x40000000)
#define EXTEN_ISINK2_DAT_9                      ((uint32_t)0x80000000)

#include "ch32m030_conf.h"
