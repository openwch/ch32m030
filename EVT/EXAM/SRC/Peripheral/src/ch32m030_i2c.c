...
void I2C_Init(I2C_TypeDef *I2Cx, I2C_InitTypeDef *I2C_InitStruct)
{
    ...
    freqrange = (uint16_t)(hclk / 1000000);
    tmpreg |= freqrange;
    I2Cx->CTLR2 = tmpreg;
    ...
    {
        result = (uint16_t)(hclk / (I2C_InitStruct->I2C_ClockSpeed << 1));
    ...
    else
    {
        ...
        {
            result = (uint16_t)(hclk / (I2C_InitStruct->I2C_ClockSpeed * 3));
        }
        else
        {
            result = (uint16_t)(hclk / (I2C_InitStruct->I2C_ClockSpeed * 25));
