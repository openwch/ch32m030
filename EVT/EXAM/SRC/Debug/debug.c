...
void USART_Printf_Init(uint32_t baudrate)
{
...
#if((DEBUG == DEBUG_UART1_NoRemap) || (DEBUG == DEBUG_UART1_Remap1))
    RCC_PB2PeriphClockCmd(RCC_PB2Periph_USART1 | RCC_PB2Periph_GPIOC, ENABLE);
#if (DEBUG == DEBUG_UART1_Remap1)
    ...
    RCC_PB2PeriphClockCmd(RCC_PB2Periph_USART1 | RCC_PB2Periph_GPIOA | RCC_PB2Periph_AFIO, ENABLE);
