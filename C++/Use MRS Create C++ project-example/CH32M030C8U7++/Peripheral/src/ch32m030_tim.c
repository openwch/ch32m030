...
{
    uint16_t tmpccmrx = 0, tmpccer = 0, tmpcr2 = 0, tmpcr1 = 0;
    ...
    {
        tmpccer &= ~((1<<6) | (1<<8));
        if(TIM_OCInitStruct->TIM_OCNPolarity)
        {
            tmpccer |= (1<<8);
        }

        if(TIM_OCInitStruct->TIM_OCPolarity)
        {
            tmpccer |= (1<<6);
        }

        tmpcr1 &= ~(1<<10);
        if(TIM_OCInitStruct->TIM_OutputNState)
        {
            tmpcr1 |= (1<<10);
            TIMx->CTLR1 = tmpcr1;
        }
 ...
 *            TIM_IT_Update - TIM update Interrupt source.(for TIM1 TIM2 TIM3)
 *            TIM_IT_CC1 - TIM Capture Compare 1 Interrupt source.(for TIM1 TIM2 TIM3)
 *            TIM_IT_CC2 - TIM Capture Compare 2 Interrupt source.(for TIM1 TIM2 TIM3)
 *            TIM_IT_CC3 - TIM Capture Compare 3 Interrupt source.(for TIM1 TIM2)
 *            TIM_IT_CC4 - TIM Capture Compare 4 Interrupt source.(for TIM1 TIM2)
 *            TIM_IT_COM - TIM Commutation Interrupt source.(for TIM1)
 *            TIM_IT_Trigger - TIM Trigger Interrupt source.(for TIM1 TIM2 TIM3)
 *            TIM_IT_Break - TIM Break Interrupt source.(for TIM1)
 *          NewState - ENABLE or DISABLE.
 *
 * @return  none
 */
 ...
 *            TIM_EventSource_CC3 - Timer Capture Compare 3 Event source.(only for TIM1,TIM2)
 *            TIM_EventSource_CC4 - Timer Capture Compare 4 Event source.(only for TIM1,TIM2)
 *            TIM_EventSource_COM - Timer COM event source.(only for TIM1)
 ...
 *            TIM_DMA_CC1 - TIM Capture Compare 1 DMA source.(for TIM1 TIM2 TIM3)
 *            TIM_DMA_CC2 - TIM Capture Compare 2 DMA source.(for TIM1 TIM2 TIM3)
 *            TIM_DMA_CC3 - TIM Capture Compare 3 DMA source.(for TIM1 TIM2)
 *            TIM_DMA_CC4 - TIM Capture Compare 4 DMA source.(for TIM1 TIM2)
 *            TIM_DMA_CC5 - TIM Capture Compare 5 DMA source.(for TIM1)
 *            TIM_DMA_COM - TIM Commutation DMA source.(for TIM1)
...
void TIM_DMACmd(TIM_TypeDef *TIMx, uint16_t TIM_DMASource, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        if(TIM_DMASource == TIM_DMA_CC5)
        {
            TIMx->TIM1_AUX1 |= (TIM_DMA_CC5 << 9);
        }
        else
        {
 ...
 *            TIM_TS_ETRF - External Trigger input(TIM3 not support).
 *
 * @return  none
 */
...
void TIM_OC5PreloadConfig(TIM_TypeDef *TIMx, uint16_t TIM_OCPreload)
{
    ...
    tmp = TIMx->TIM1_AUX1;
    tmp &= (uint16_t) ~((uint16_t)(1 << 5));
    tmp |= (uint16_t)(TIM_OCPreload << 2);
    TIMx->TIM1_AUX1 = tmp;
}

/*********************************************************************
 * @fn      TIM_OC6PreloadConfig
 *
...
void TIM_OC6PreloadConfig(TIM_TypeDef *TIMx, uint16_t TIM_OCPreload)
{
    ...
    tmp = TIMx->TIM1_AUX1;
    tmp &= (uint16_t) ~((uint16_t)(1 << 6));
    tmp |= (uint16_t)(TIM_OCPreload << 3);
    TIMx->TIM1_AUX1 = tmp;
}

/*********************************************************************
 * @fn      TIM_OC7PreloadConfig
 *
 * @brief   Enables or disables the TIMx peripheral Preload register on CCR7.
 *
 * @param   TIMx - where x can be 1 to select the TIM peripheral.
 *          TIM_OCPreload - new state of the TIMx peripheral Preload register.
 *            TIM_OCPreload_Enable.
 ...
 * @return  none
 */
void TIM_OC7PreloadConfig(TIM_TypeDef *TIMx, uint16_t TIM_OCPreload)
{
    uint16_t tmp = 0;

    tmp = TIMx->TIM1_AUX1;
    tmp &= (uint16_t) ~((uint16_t)(1 << 7));
    tmp |= (uint16_t)(TIM_OCPreload << 4);
    TIMx->TIM1_AUX1 = tmp;
}

/*********************************************************************
 * @fn      TIM_OC8PreloadConfig
 *
 * @brief   Enables or disables the TIMx peripheral Preload register on CCR8.
 *
 * @param   TIMx - where x can be 1 to select the TIM peripheral.
 *          TIM_OCPreload - new state of the TIMx peripheral Preload register.
 *            TIM_OCPreload_Enable.
 ...
 * @return  none
 */
void TIM_OC8PreloadConfig(TIM_TypeDef *TIMx, uint16_t TIM_OCPreload)
{
    uint16_t tmp = 0;

    tmp = TIMx->TIM1_AUX1;
    tmp &= (uint16_t) ~((uint16_t)(1 << 8));
    tmp |= (uint16_t)(TIM_OCPreload << 5);
    TIMx->TIM1_AUX1 = tmp;
}
 ...
 *
 * @param   TIMx - where x can be 1 to 2 select the TIM peripheral.
 *          TIM_OCPolarit - specifies the OC4 Polarity.
 *            TIM_OCPolarity_High - Output Compare active high.
 *            TIM_OCPolarity_Low - Output Compare active low.
 *
 * @return  none
 ...
 *            TIM_Channel_3 - TIM Channel 3.(TIM3 not support)
 *            TIM_Channel_4 - TIM Channel 4.(TIM3 not support)
 ...
 * @return  none
 */
void TIM_SetCompare5(TIM_TypeDef *TIMx, uint16_t Compare5)
{
    TIMx->TIM1_CH5CVR = Compare5;
}
 ...
 * @return  none
 */
void TIM_SetCompare6(TIM_TypeDef *TIMx, uint16_t Compare6)
{
    TIMx->TIM1_CH6CVR = Compare6;
}

/*********************************************************************
 * @fn      TIM_SetCompare7
 *
 * @brief   Sets the TIMx Capture Compare7 Register value.
 *
 * @param   TIMx - where x can be 1 select the TIM peripheral.
 *          Compare7 - specifies the Capture Compare7 register new value.
 *
 * @return  none
 */
void TIM_SetCompare7(TIM_TypeDef *TIMx, uint16_t Compare7)
{
    TIMx->TIM1_CH7CVR = Compare7;
}

/*********************************************************************
 * @fn      TIM_SetCompare8
 *
 * @brief   Sets the TIMx Capture Compare8 Register value.
 *
 * @param   TIMx - where x can be 1 select the TIM peripheral.
 *          Compare8 - specifies the Capture Compare8 register new value.
 *
 * @return  none
 */
void TIM_SetCompare8(TIM_TypeDef *TIMx, uint16_t Compare8)
{
    TIMx->TIM1_CH8CVR = Compare8;
}
 ...
 *            TIM_FLAG_CC3 - TIM Capture Compare 3 Flag.(for TIM1 TIM2)
 *            TIM_FLAG_CC4 - TIM Capture Compare 4 Flag.(for TIM1 TIM2)
 *            TIM_FLAG_COM - TIM Commutation Flag.(for TIM1)
 *            TIM_FLAG_Trigger - TIM Trigger Flag.
 *            TIM_FLAG_Break - TIM Break Flag.(for TIM1)
 *            TIM_FLAG_CC1OF - TIM Capture Compare 1 overcapture Flag.
 *            TIM_FLAG_CC2OF - TIM Capture Compare 2 overcapture Flag.
 *            TIM_FLAG_CC3OF - TIM Capture Compare 3 overcapture Flag.(for TIM1 TIM2)
 *            TIM_FLAG_CC4OF - TIM Capture Compare 4 overcapture Flag.(for TIM1 TIM2)
 *
 * @return  SET or RESET.
 */
 ...
 *          TIM_DTPolarity - TIM2 dead time Polarity.
 *            TIM_DTPolarity_Rising - TIM2 dead time Polarity rising.
 *            TIM_DTPolarity_Falling - TIM2 dead time Polarity falling.
 *          DT_DIV - DeadTime counting frequency division.
 *            TIM_DT_DIV1 - DeadTime counting frequency division by 1.
 *            TIM_DT_DIV4 - DeadTime counting frequency division by 4.
 *
 * @return  none
 */
void TIM2_DeadTimeConfig(TIM_TypeDef *TIMx, uint16_t TIM_DTPolarity, uint8_t DeadTime, uint8_t DT_DIV)
{
    if(TIMx == TIM2)
    {
        TIMx->TIM2_DTCR &= ~((0xF << (TIM_DTPolarity + 8)));
        TIMx->TIM2_DTCR |= ((uint16_t)DeadTime) << (TIM_DTPolarity + 8);
        TIMx->TIM2_DTCR &= ~(1 << 6);
        TIMx->TIM2_DTCR |= (DT_DIV << 6);
    }
}

/*********************************************************************
 * @fn      TIM3_DeadTimeConfig
 *
 * @brief   Configures the TIM3 complementary output dead time.
 *
 * @param   TIMx - where x can be 3 to select the TIM peripheral.
 *          DeadTime - This parameter can be a number between 0x00 and 0xFF.
 ...
 * @return  none
 */
void TIM3_DeadTimeConfig(TIM_TypeDef *TIMx, uint16_t TIM_Channel, uint8_t DeadTime, uint8_t DT_DIV)
{
     if(TIMx == TIM3)
    {
        ...
        {
            TIMx->SMCFGR &= ~(0xF<<8);
            TIMx->SMCFGR |= ((uint16_t)DeadTime << 8);
            TIMx->CTLR1 &= ~(1<<10);
            TIMx->CTLR1 |= (1<<10);
        }
        ...
        {
            TIMx->SMCFGR &= ~(0xF<<12);
            TIMx->SMCFGR |= ((uint16_t)DeadTime << 12);
            TIMx->CTLR1 &= ~(1<<11);
            TIMx->CTLR1 |= (1<<11);
        }
...
/*********************************************************************
 * @fn      TIM_CLKSourceConfig
 *
 * @brief   Configures the TIMx clock source.
 *
 * @param   TIMx - where x can be 1 to 3 to select the TIM peripheral.
 *          TIM_CLKSource - specifies the PLL entry clock source.
 *            TIM_CLKSource_HCLK - HCLK clock selected as TIMx
 *        clock entry.
 *            TIM_CLKSource_PLL - HPLL clock selected as TIMx
 *        clock entry.
 *
 * @return  none
 */
void TIM_CLKSourceConfig(TIM_TypeDef *TIMx, uint32_t TIM_CLKSource)
{
    if(TIMx == TIM1)
    {
        TIMx->TIM1_AUX1 &= ~(TIM_CLKSource_PLL << 14);
        TIMx->TIM1_AUX1 |= (TIM_CLKSource << 14);
    }
    else if(TIMx == TIM2)
    {
        TIMx->CTLR2 &= ~(TIM_CLKSource_PLL << 9);
        TIMx->CTLR2 |= (TIM_CLKSource << 9);
    }
    else if(TIMx == TIM3)
    {
        TIMx->CCER &= ~(TIM_CLKSource_PLL << 13);
        TIMx->CCER |= (TIM_CLKSource << 13);
    }
}

/*********************************************************************
 * @fn      TIM_CapEdgeADC_Cmd
 *
 * @brief   Enables or disables the ADC edge capture.
 *
 * @param   TIMx - where x can be 1 to 3 to select the TIM peripheral.
 *          NewState - ENABLE or DISABLE.
 *
 * @return  none
 */
void TIM_CapEdgeADC_Cmd(TIM_TypeDef *TIMx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        if(TIMx == TIM1)
 ...
 *
 * @brief   Configures the TIMx complementary output asymmetric dead time.
 *
 * @param   TIMx - where x can be 1 to select the TIM peripheral.
 *          AsymmetricDeadTime - This parameter can be a number between 0x00
 *        and BDTR DTG[7:0].
 *          DT_MODE - Dead time mode.
 *            TIM_DT_MODE_Disable - Disable Dead time mode.
 *            TIM_DT_MODE_Rising - Dead time mode occur to the rising of OCXREF.
 *            TIM_DT_MODE_Falling - Dead time mode occur to the falling of OCXREF.
 *            TIM_DT_MODE_BothEdge - Dead time mode occur to the falling
 *        and rising of OCXREF.
 *
 * @return  none
 */
void TIM_AsymmetricDeadTimeConfig(TIM_TypeDef *TIMx, uint8_t AsymmetricDeadTime, uint16_t DT_MODE)
{
    TIMx->TIM1_AUX2 &= ~(0x3FF);
    TIMx->TIM1_AUX2 |= (AsymmetricDeadTime | DT_MODE);
}

/*********************************************************************
 * @fn      TIM_CenterAlignedMoveToward_Cmd
 *
 * @brief   Enables or disables the center aligned move toward the TIMx.
 *
 * @param   TIMx - where x can be 1 to select the TIM peripheral.
 *          NewState - ENABLE or DISABLE.
 *
 * @return  none
 */
void TIM_CenterAlignedMoveToward_Cmd(TIM_TypeDef *TIMx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        TIMx->TIM1_AUX1 |= (1<<3);
...
/*********************************************************************
 * @fn      TIM_IndependentOutput_ChannelxN_Cmd
 *
 * @brief   Enable independent PWM output function in edge alignment mode.
 *
 * @param   TIMx - where x can be 1 to select the TIM peripheral.
 *          TIM_Channel - specifies the TIM Channel.
 *            TIM_Channel_1N - TIM Channel 1N.
 *            TIM_Channel_2N - TIM Channel 2N.
 *            TIM_Channel_3N - TIM Channel 3N.
 *          NewState - ENABLE or DISABLE.
 *
 * @return  none
 */
void TIM_IndependentOutput_ChannelxN_Cmd(TIM_TypeDef *TIMx, uint16_t TIM_Channel, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        TIMx->TIM1_AUX1 |= (TIM_Channel>>1);
    }
    else
    {
        TIMx->TIM1_AUX1 &= ~(TIM_Channel>>1);
...
/*********************************************************************
 * @fn      TIM_ChannelxPWMModeConfig
 *
 * @brief   Configures the mode of channelx.
 *
 * @param   TIMx - where x can be 1 to select the TIM peripheral.
 *          TIM_Channel - specifies the TIM Channel.
 *            TIM_Channel_1N - TIM Channel 1N.
 ...
 * @return  none
 */
void TIM_ChannelxPWMModeConfig(TIM_TypeDef *TIMx, uint16_t TIM_Channel, uint16_t TIM_OCMode)
{
    if(TIM_OCMode == TIM_OCMode_PWM2)
    {
        TIMx->TIM1_AUX2 |= (TIM_Channel);
    }
    else if(TIM_OCMode == TIM_OCMode_PWM1)
    {
        TIMx->TIM1_AUX2 &= ~(TIM_Channel);
    }
}
...
/*********************************************************************
 * @fn      TIM2_CH2PWMOUTPinConfig
 *
 * @brief   Enables or disables TIM2 CH2 PWM output pin to PC5.
 *
 * @param   TIMx - where x can be 2 to select the TIM peripheral.
 *          NewState - ENABLE or DISABLE.
 *
 * @return  none
 */
void TIM2_CH2PWMOUTPinConfig(TIM_TypeDef *TIMx, FunctionalState NewState)
{
    if(TIMx == TIM2)
    {
        if(NewState != DISABLE)
